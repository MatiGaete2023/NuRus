...
| ACEP-03 | Editar en Trabajo y exportar directamente | Sin pulsar antes “Aplicar edición”, la copia contiene la observación visible; fila editada `REVISADO`, filas intactas `PENDIENTE`; TT/CC/RES previos no se borran | Pendiente |
...
| ACEP-08 | Clasificar resoluciones | Tipo explícito en RES prevalece; si RES solo marca, la observación discrimina PC_IE/PC_INFO/NOMENCL; una observación sin acción ni RES no crea proyecto | Pendiente |

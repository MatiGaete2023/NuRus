...
Verificación vigente: commit `8546dab08ae9976c2e0f26810e2e49d5fee30ced`, run `35729404913`, Windows Python 3.12/3.13/3.14 **success**, **256 pruebas aprobadas y 1 omitida por versión**; smoke CustomTkinter y construcción de la distribución dev10 correctos en 3.12.

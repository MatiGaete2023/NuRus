...
Actualizado: 16 de septiembre de 2026. Versión vigente: **0.4.0.dev6**.
...
- `AUDITORIA_REPOSITORIO_20260916.md`: auditoría integral y limpieza de código del 16-09-2026.
- `CAMBIOS_USO_20260914.md`: historial consolidado iniciado el 14-09 y actualizado con la tanda del 16-09.
...
Referencias históricas a CI Linux, versiones dev1/dev2/dev6/dev7 anteriores, excepción obligatoria de cruce o arquitecturas previas deben interpretarse dentro de su fecha. La coincidencia del identificador “dev6” con una documentación histórica no convierte aquella documentación en vigente: la release actual se identifica además por la rama y el SHA de 16-09-2026.

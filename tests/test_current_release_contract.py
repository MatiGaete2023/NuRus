...
def test_release_version_and_current_docs_are_aligned():
    ...
    assert project['project']['version']==nurus.__version__=='0.4.0.dev8'
    current_docs=[
        ROOT/'README.md', ROOT/'docs/IMPLEMENTACION.md', ROOT/'docs/IMPLEMENTACION_PERSONAL.md',
        ROOT/'docs/LIMPIEZA_ASISTENTE_20260921.md', ROOT/'docs/VERIFICACION_PERSONAL.md',
...
def test_workflow_and_distribution_match_current_release():
    ...
    assert 'CSMP_Assistant_personal_0.4.0-dev8.zip' in workflow
    assert 'CSMP-Windows-dev8' in workflow

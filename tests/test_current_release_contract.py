...
def test_release_version_and_current_docs_are_aligned():
    ...
    assert project['project']['version']==nurus.__version__=='0.4.0.dev7'
    current_docs=[
        ROOT/'README.md', ROOT/'docs/IMPLEMENTACION.md', ROOT/'docs/IMPLEMENTACION_PERSONAL.md',
        ROOT/'docs/REVISION_USABILIDAD_20260921.md', ROOT/'docs/VERIFICACION_PERSONAL.md',
    ...
    assert '21 de septiembre de 2026' in readme
...
def test_workflow_and_distribution_match_current_release():
    ...
    assert 'CSMP_Assistant_personal_0.4.0-dev7.zip' in workflow
    assert 'CSMP-Windows-dev7' in workflow

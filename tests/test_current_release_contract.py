...
def test_release_version_and_current_docs_are_aligned():
    ...
    assert project['project']['version']==nurus.__version__=='0.4.0.dev9'
    current_docs=[
        ROOT/'README.md', ROOT/'docs/IMPLEMENTACION.md', ROOT/'docs/IMPLEMENTACION_PERSONAL.md',
        ROOT/'docs/PANEL_CORREOS_20260921.md', ROOT/'docs/VERIFICACION_PERSONAL.md',
...
def test_workflow_and_distribution_match_current_release():
    ...
    assert 'CSMP_Assistant_personal_0.4.0-dev9.zip' in workflow
    assert 'CSMP-Windows-dev9' in workflow
